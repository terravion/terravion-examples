...
class TerrAvionAPI2Layer:
    def __init__(self, user_id, access_token, epoch_start=None,
                 epoch_end=None, add_epoch_start=None, add_epoch_end=None):
    ...
    def get_layers(self, block_id=None, field_name=None):
        ...
        if not block_id and self.epoch_start and self.epoch_end and self.add_epoch_start and self.add_epoch_end and field_name:
